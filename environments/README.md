...
| --- | --- | --- |
| SCAR / PaAno | `scar-paano-cu126.yml` | Formal target: Python 3.11, PyTorch 2.7.1, CUDA 12.6; NumPy 1.26.4 satisfies TSB-AD 1.5's `<2.0` constraint; includes statsmodels for PaAno |
